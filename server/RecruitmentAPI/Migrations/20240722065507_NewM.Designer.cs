...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecruitmentAPI.Entities.BackOfficeJobListing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("RecruitmentAPI.Entities.JobApplication", b =>
                {
                    ...
                    b.ToTable("JobApplications", "operation");
                });
            ...
            modelBuilder.Entity("RecruitmentAPI.Entities.User", b =>
                {
                    ...
                    b.ToTable("Users", "userapplication");
                });

            modelBuilder.Entity("RecruitmentAPI.Entities.BackOfficeJobListing", b =>
                {
                    b.HasOne("RecruitmentAPI.Entities.Employer", "Employer")
            ...
            modelBuilder.Entity("RecruitmentAPI.Entities.JobApplication", b =>
                {
                    b.HasOne("RecruitmentAPI.Entities.BackOfficeJobListing", "BackOfficeJobListing")
                    ...
                    b.HasOne("RecruitmentAPI.Entities.User", "User")
                        .WithMany("JobApplications")
